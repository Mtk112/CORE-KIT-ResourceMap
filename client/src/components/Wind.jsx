        ...
        return(
            <>
                <Plot
                    ...
                    layout={{width: 450, height: 250, margin: {l: 40, r: 15, b: 75, t: 35, pad: 2}, xaxis: {autotick: false, ticks: 'outside', tick0: 0, dtick: 1, title: 'Month'}, yaxis:{title: 'Windspeed (m/s)'}, title: 'Windspeed at 50m'}}
